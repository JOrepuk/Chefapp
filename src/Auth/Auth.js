...
import {registerAsyncActionCreator, logInAsyncActionCreator, resetPasswordAsyncActiobCreator} from '../state/auth'
...
const mapDispatchToProps = dispatch => ({
    ...
    _resetPassword: (email, success) => dispatch(resetPasswordAsyncActiobCreator(email, success))
})
